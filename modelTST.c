...
int main() {
    ...
    while (userInput != '0') {
        ...
        updateChuck(&modelTestDriver.chuck); 
        ...
        modelTestDriver.chuck.y = 8;
        cond_update(&modelTestDriver);
        printf("Cross count after crossing: %d\n", modelTestDriver.crossCount);
        */
        printf("Road[%d]: %d, %d \n",i,modelTestDriver.road[i].x,modelTestDriver.road[i].y);
        i++;
        scanf(" %c", &userInput);
        /*if (userInput == 'l' ) {
...
void checkLand(Model *model){
    ...
    printf("================================================================================================\n");
    for (k = 0; k<40; k++) {   
        printf("Road[%d]: %d, %d \n",k,modelTestDriver->road[k].x,modelTestDriver->road[k].y);
    }
    printf("================================================================================================\n");
}